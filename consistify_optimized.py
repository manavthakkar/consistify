...
final_img, month_name, binary_array  = process_image_and_generate_collage(img, year, 50)

# resize the final image (percentage equally in both dimensions)
final_img = cv2.resize(final_img, (0, 0), fx=0.3, fy=0.3)
